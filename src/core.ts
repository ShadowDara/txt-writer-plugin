...
export function replaceTimelineMarkdownDocument(
  existingMarkdown: string,
  timelineMarkdown: string,
  fallbackTitle: string
): string {
  const title = extractMarkdownTitle(existingMarkdown) ?? fallbackTitle;
...
export function createTimelineMarkdownDocument(title: string, timelineMarkdown: string): string {
  return `---
tags:
  - timeline
---
